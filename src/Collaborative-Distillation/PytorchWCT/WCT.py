...
# Navigate one level up to get the project root directory
root_path = os.path.dirname(current_script_dir)

# Function to join root path with relative path
def get_absolute_path(relative_path):
    return os.path.join(root_path, relative_path)

#if args.mode == "original" or args.mode == None:
#    args.e5 = get_absolute_path('trained_models/original_wct_models/vgg_normalised_conv5_1.pth')
#    args.e4 = get_absolute_path('trained_models/original_wct_models/vgg_normalised_conv4_1.pth')
#    args.e3 = get_absolute_path('trained_models/original_wct_models/vgg_normalised_conv3_1.pth')
#    args.e2 = get_absolute_path('trained_models/original_wct_models/vgg_normalised_conv2_1.pth')
#    args.e1 = get_absolute_path('trained_models/original_wct_models/vgg_normalised_conv1_1.pth')
#    args.d5 = get_absolute_path('trained_models/original_wct_models/feature_invertor_conv5_1.pth')
#    args.d4 = get_absolute_path('trained_models/original_wct_models/feature_invertor_conv4_1.pth')
#    args.d3 = get_absolute_path('trained_models/original_wct_models/feature_invertor_conv3_1.pth')
#    args.d2 = get_absolute_path('trained_models/original_wct_models/feature_invertor_conv2_1.pth')
#    args.d1 = get_absolute_path('trained_models/original_wct_models/feature_invertor_conv1_1.pth')

#elif args.mode == "16x":
args.e5 = get_absolute_path('trained_models/wct_se_16x_new/5SE.pth')
args.e4 = get_absolute_path('trained_models/wct_se_16x_new/4SE.pth')
args.e3 = get_absolute_path('trained_models/wct_se_16x_new/3SE.pth')
args.e2 = get_absolute_path('trained_models/wct_se_16x_new/2SE.pth')
args.e1 = get_absolute_path('trained_models/wct_se_16x_new/1SE.pth')
args.d5 = get_absolute_path('trained_models/wct_se_16x_new_sd/5SD.pth')
args.d4 = get_absolute_path('trained_models/wct_se_16x_new_sd/4SD.pth')
args.d3 = get_absolute_path('trained_models/wct_se_16x_new_sd/3SD.pth')
args.d2 = get_absolute_path('trained_models/wct_se_16x_new_sd/2SD.pth')
args.d1 = get_absolute_path('trained_models/wct_se_16x_new_sd/1SD.pth')
...
#    args.e2 = get_absolute_path('trained_models/wct_se_16x_new/2SE.pth')
#    args.e1 = get_absolute_path('trained_models/wct_se_16x_new/1SE.pth')
#    args.d5 = get_absolute_path('trained_models/wct_se_16x_new_sd_kd2sd/5SD.pth')
#    args.d4 = get_absolute_path('trained_models/wct_se_16x_new_sd_kd2sd/4SD.pth')
#    args.d3 = get_absolute_path('trained_models/wct_se_16x_new_sd_kd2sd/3SD.pth')
#    args.d2 = get_absolute_path('trained_models/wct_se_16x_new_sd_kd2sd/2SD.pth')
#    args.d1 = get_absolute_path('trained_models/wct_se_16x_new_sd_kd2sd/1SD.pth')

# Example of loading a model (ensure you use the correct loading function for your models)
# model_e5 = torch.load(args.e5)
# model_d1 = torch.load(args.d1)
